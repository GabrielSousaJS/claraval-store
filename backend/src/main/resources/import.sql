...
-- Eletrônicos
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('iPhone 13 Pro', 'The latest flagship smartphone from Apple featuring a stunning Super Retina XDR display, A15 Bionic chip, Pro camera system, 5G connectivity, and iOS 15.', 6291.30, 17,'https://www.example.com/images/iphone13pro.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('iPad Pro (2021)', 'The ultimate tablet for power users with an M1 chip, 12.9-inch Liquid Retina XDR display, 5G connectivity, and support for Apple Pencil and Magic Keyboard.', 8194.70, 10,'https://www.example.com/images/ipadpro2021.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Dell XPS 13 (2021)', 'A beautifully designed laptop with a virtually borderless display, 11th Gen Intel Core processors, and advanced thermal technology for improved performance.', 6919.70, 22,'https://www.example.com/images/dellxps13.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Samsung QN90A Neo QLED', 'Experience the next level of picture quality with Samsung Neo QLED technology. Features an ultra-slim design, 4K resolution, and powerful AI upscaling.', 11336.70, 5,'https://www.example.com/images/samsungqn90a.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Canon EOS R6', 'A full-frame mirrorless camera with advanced autofocus and image stabilization, 4K video recording, and built-in Wi-Fi and Bluetooth connectivity.', 15742.70, 9,'https://www.example.com/images/canoneosr6.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Bose SoundLink Revolve+', 'A portable Bluetooth speaker with 360-degree sound and up to 16 hours of battery life. Water-resistant and durable, perfect for outdoor use.', 1886.70, 11,'https://www.example.com/images/bosesoundlink.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('JBL Flip 5 Portable Bluetooth Speaker', 'A compact and powerful Bluetooth speaker with up to 12 hours of battery life, waterproof design, and PartyBoost feature for stereo sound.', 750.30, 25,'https://www.example.com/images/jblflip5.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Xbox Series X', 'The Xbox Series X is a powerful next-generation gaming console from Microsoft, featuring a custom AMD Zen 2 processor, 16GB of GDDR6 RAM, and a 1TB solid-state drive.', 3145.70, 13,'https://example.com/xboxseriesx.jpg', NOW());

-- Vestuário
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Basic T-shirt', '100% cotton unisex T-shirt', 29.90, 18,'https://example.com/img/t-shirt.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Hoodie sweatshirt', '100% cotton hoodie sweatshirt, lined, with hood', 89.90, 24,'https://example.com/img/hoodie.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Jeans pants', 'Slim fit jeans pants, dark wash', 119.90, 8,'https://example.com/img/jeans-pants.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Leather jacket', 'Synthetic leather jacket, lined, with zipper', 199.90, 12,'https://example.com/img/leather-jacket.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Dress shoes', 'Classic leather dress shoes', 179.90, 16,'https://example.com/img/dress-shoes.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Beach shorts', 'Printed beach shorts, men model', 49.90, 23,'https://example.com/img/beach-shorts.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Long dress', 'Printed long dress, women model', 149.90, 21,'https://example.com/img/long-dress.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Sport sneakers', 'Knit sport sneakers, with rubber sole', 99.90, 7,'https://example.com/img/sport-sneakers.jpg', NOW());

-- Itens para casa e decoração
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Floral Print Cushion Cover', 'Cushion cover with floral print, made of cotton', 19.99, 14,'https://example.com/img/floral-cushion-cover.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Abstract Canvas Wall Art', 'Abstract canvas wall art, hand-painted, 36x24 inches', 129.99, 19,'https://example.com/img/abstract-canvas-wall-art.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Scented Candle', 'Scented candle with lavender fragrance, made of soy wax', 29.99, 20,'https://example.com/img/scented-candle.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Decorative Wall Mirror', 'Decorative wall mirror with gold frame, 30x24 inches', 89.99, 6,'https://example.com/img/decorative-wall-mirror.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Area Rug', 'Area rug with geometric pattern, made of wool, 6x9 feet', 299.99, 15,'https://example.com/img/area-rug.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Table Lamp', 'Table lamp with ceramic base and linen shade', 59.99, 11,'https://example.com/img/table-lamp.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Decorative Throw Pillow', 'Decorative throw pillow with geometric print, made of cotton, 18x18 inches', 24.99, 25,'https://example.com/img/decorative-throw-pillow.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Wall Clock', 'Wall clock with wooden frame and metal hands, 12 inches', 39.99, 16,'https://example.com/img/wall-clock.jpg', NOW());

-- Artigos esportivos
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Running shoes', 'Breathable running shoes, perfect for outdoor activities', 119.90, 9,'https://example.com/img/running-shoes.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Yoga mat', 'Non-slip yoga mat with comfortable cushioning', 69.90, 20,'https://example.com/img/yoga-mat.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Dumbbell set', 'Set of 2 dumbbells, adjustable weight from 2 to 10kg', 249.90, 17,'https://example.com/img/dumbbell-set.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Cycling helmet', 'Lightweight cycling helmet with adjustable strap', 89.90, 22,'https://example.com/img/cycling-helmet.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Basketball', 'Indoor/outdoor basketball, official size and weight', 39.90, 7,'https://example.com/img/basketball.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Tennis racket', 'Lightweight tennis racket with carbon fiber frame', 149.90, 14,'https://example.com/img/tennis-racket.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Swimming goggles', 'Anti-fog swimming goggles with UV protection', 29.90, 12,'https://example.com/img/swimming-goggles.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Fitness tracker', 'Smartwatch with heart rate monitor and step counter', 199.90, 8,'https://example.com/img/fitness-tracker.jpg', NOW());

-- Livros
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('The Lord of The Rings', 'Fantasy novel by J.R.R. Tolkien', 79.99, 23,'https://example.com/img/lotr.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('1984', 'Dystopian novel by George Orwell', 29.90, 19,'https://example.com/img/1984.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('To Kill a Mockingbird', 'Novel by Harper Lee', 39.99, 21,'https://example.com/img/mockingbird.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Pride and Prejudice', 'Novel by Jane Austen', 24.99, 10,'https://example.com/img/pride.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('The Catcher in the Rye', 'Novel by J.D. Salinger', 34.90, 6,'https://example.com/img/catcher.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('The Great Gatsby', 'Novel by F. Scott Fitzgerald', 49.90, 15,'https://example.com/img/gatsby.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('The Hobbit', 'Fantasy novel by J.R.R. Tolkien', 44.99, 18,'https://example.com/img/hobbit.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('The Da Vinci Code', 'Mystery novel by Dan Brown', 29.99, 5,'https://example.com/img/davinci.jpg', NOW());

-- Brinquedos e jogos
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Action figure', 'Action figure of Spider-Man, 15 cm tall, articulated', 39.90, 24,'https://example.com/img/spiderman.jpg', NOW());

INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Board game', 'Monopoly board game, classic edition', 79.90, 13,'https://example.com/img/monopoly.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Lego set', 'Lego set of Harry Potter Hogwarts Castle, 6020 pieces', 1999.90, 16,'https://example.com/img/lego-harrypotter.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Puzzle', '1000 piece puzzle of Van Gogh Starry Night', 49.90, 7,'https://example.com/img/puzzle-vangogh.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Barbie doll', 'Barbie doll of Olympic athlete, fully articulated', 79.90, 20,'https://example.com/img/barbie-athlete.jpg', NOW());
INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('RC car', 'RC car of Lamborghini Aventador, 1:24 scale', 149.90, 19,'https://example.com/img/rc-car-lambo.jpg', NOW());

INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('Funko Pop', 'Funko Pop figure of Darth Vader from Star Wars', 49.90, 11,'https://example.com/img/funko-darthvader.jpg', NOW());

INSERT INTO products (name, description, price, quantity, img_Url, created_At) VALUES ('FIFA 22', 'Video game of FIFA 22 for Xbox Series X', 299.90, 25,'https://example.com/img/fifa22-xbox.jpg', NOW());
